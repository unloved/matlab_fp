...
if (ADD)
    [N,T,H,HOPTIME] = add_hash(ADD, SKIP, MAXDUR, DENSITY, FILE_TYPE);
end

if (MATCH)
    [R,N,T,HOPTIME] = match_hash(MATCH, SKIP, MAXDUR, DENSITY, OVERSAMP, FILE_TYPE);
end
