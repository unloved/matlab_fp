function [L,thop,S,T,maxes] = find_landmarks(D,SR,N,OVERSAMP)
% [L,thop,S,T,maxes] = find_landmarks(D,SR,N,OVERSAMP)
...
%   thop is the frame period of the analysis (approx 0.032,
%   quantized to SR)
